[[Veteran]] is a Yogscast-used role in [[Trouble in Terrorist Town]].
...
## Role Function
Innocent combat specialist role with stronger dueling and clutch potential.
...
Ability = {
  "id": "ability.veteran",
  "name": "Veteran Ability",
  "requirements": [
    "Actor currently has the 'Veteran' role",
  ...
  "effects": [
    {
      ...
      "event": {
        ...
        "Payload": {
          "role": "Veteran",
          "ability_function": "Innocent combat specialist role with stronger dueling and clutch potential.",
