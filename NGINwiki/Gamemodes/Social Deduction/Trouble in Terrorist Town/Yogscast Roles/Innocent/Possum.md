[[Possum]] is a Yogscast-used role in [[Trouble in Terrorist Town]].
...
## Role Function
Innocent trick role that can fake death and re-enter fights after being written off.
...
Ability = {
  ...
  "name": "Possum Ability",
  "requirements": [
    "Actor currently has the 'Possum' role",
  ...
  "effects": [
    {
      ...
      "event": {
        ...
        "Payload": {
          "role": "Possum",
          "ability_function": "Innocent trick role that can fake death and re-enter fights after being written off.",
