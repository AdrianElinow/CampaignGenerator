[[Phantom]] is a Yogscast-used role in [[Trouble in Terrorist Town]].
...
Ability = {
  "id": "ability.phantom",
  "name": "Phantom Ability",
  "requirements": [
    "Actor currently has the 'Phantom' role",
  ...
  "effects": [
    {
      ...
      "event": {
        ...
        "Payload": {
          "role": "Phantom",
          "ability_function": "Innocent revenge-info role that haunts its killer and can return when the haunted player dies.",
