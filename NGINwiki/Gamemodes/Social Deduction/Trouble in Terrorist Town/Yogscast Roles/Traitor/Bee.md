[[Bee]] is a Yogscast-used role in [[Trouble in Terrorist Town]].
...
## Role Function
Traitor-aligned bee-event role that pressures enemies with bee-based weapon attacks.
...
Ability = {
  ...
  "name": "Bee Ability",
  "requirements": [
    "Actor currently has the 'Bee' role",
  ...
  "effects": [
    {
      ...
      "event": {
        ...
        "Payload": {
          "role": "Bee",
          "ability_function": "Traitor-aligned bee-event role that pressures enemies with bee-based weapon attacks.",
