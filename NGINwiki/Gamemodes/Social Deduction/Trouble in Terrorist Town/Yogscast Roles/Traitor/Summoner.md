[[Summoner]] is a Yogscast-used role in [[Trouble in Terrorist Town]].
...
Ability = {
  "id": "ability.summoner",
  "name": "Summoner Ability",
  "requirements": [
    "Actor currently has the 'Summoner' role",
  ...
  "effects": [
    {
      ...
      "event": {
        ...
        "Payload": {
          "role": "Summoner",
          "ability_function": "Traitor utility role that calls in additional pressure entities/effects to swing fights.",
