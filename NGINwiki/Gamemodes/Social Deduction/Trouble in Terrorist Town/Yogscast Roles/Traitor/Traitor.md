[[Traitor]] is a Yogscast-used role in [[Trouble in Terrorist Town]].
...
## Role Function
Core hidden evil role with buy menu access and win condition to eliminate non-traitors.
  ...
  "effects": [
    {
      ...
      "event": {
        ...
        "Payload": {
          "role": "Traitor",
          "ability_function": "Core hidden evil role with buy menu access and win condition to eliminate non-traitors.",
