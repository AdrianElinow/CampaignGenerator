...
Ability = {
  ...
  "name": "Faker Ability",
  "requirements": [
    "Actor currently has the 'Faker' role",
  ...
  "effects": [
    {
      ...
      "event": {
        ...
        "Payload": {
          "role": "Faker",
          "ability_function": "Jester role that uses harmless fake traitor items; wins by successfully faking item usage near others.",
...
- Goal State: Satisfy Faker's personal jester-style victory trigger before standard team wins resolve.
