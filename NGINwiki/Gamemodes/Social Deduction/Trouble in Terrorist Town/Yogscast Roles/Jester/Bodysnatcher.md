[[Bodysnatcher]] is a Yogscast-used role in [[Trouble in Terrorist Town]].
...
## Role Function
Jester chaos role built around corpse/body-interaction deception and identity confusion.
...
```json
Ability = {
  "id": "ability.bodysnatcher",
  "name": "Bodysnatcher Ability",
  "requirements": [
    "Actor currently has the 'Bodysnatcher' role",
  ...
  "effects": [
    {
      ...
      "event": {
        ...
        "Payload": {
          "role": "Bodysnatcher",
          "ability_function": "Jester chaos role built around corpse/body-interaction deception and identity confusion.",
...
- Goal State: Satisfy Bodysnatcher's personal jester-style victory trigger before standard team wins resolve.
