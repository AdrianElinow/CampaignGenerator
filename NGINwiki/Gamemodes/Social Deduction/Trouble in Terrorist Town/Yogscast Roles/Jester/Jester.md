[[Jester]] is a Yogscast-used role in [[Trouble in Terrorist Town]].
...
## Role Function
Non-damaging chaos role that aims to be killed to trigger a personal win condition.
...
Ability = {
  ...
  "name": "Jester Ability",
  "requirements": [
    "Actor currently has the 'Jester' role",
  ...
  "effects": [
    {
      ...
      "event": {
        ...
        "Payload": {
          "role": "Jester",
          "ability_function": "Non-damaging chaos role that aims to be killed to trigger a personal win condition.",
...
- Goal State: Satisfy Jester's personal jester-style victory trigger before standard team wins resolve.
