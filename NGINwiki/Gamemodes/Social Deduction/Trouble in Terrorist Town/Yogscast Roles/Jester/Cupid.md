[[Cupid]] is a Yogscast-used role in [[Trouble in Terrorist Town]].
...
## Role Function
Creates player links/pairs that alter social incentives, trust, and target priorities.
...
Ability = {
  ...
  "name": "Cupid Ability",
  "requirements": [
    "Actor currently has the 'Cupid' role",
  ...
  "effects": [
    {
      ...
      "event": {
        ...
        "Payload": {
          "role": "Cupid",
          "ability_function": "Creates player links/pairs that alter social incentives, trust, and target priorities.",
...
- Goal State: Satisfy Cupid's personal jester-style victory trigger before standard team wins resolve.
