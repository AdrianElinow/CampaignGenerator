[[Detectoclown]] is a Yogscast-used role in [[Trouble in Terrorist Town]].
...
## Role Function
Jester-aligned deceptive role that mimics detective expectations to bait misplays.
...
```json
Ability = {
  "id": "ability.detectoclown",
  "name": "Detectoclown Ability",
  "requirements": [
    "Actor currently has the 'Detectoclown' role",
  ...
  "effects": [
    {
      ...
      "event": {
        ...
        "Payload": {
          "role": "Detectoclown",
          "ability_function": "Jester-aligned deceptive role that mimics detective expectations to bait misplays.",
