[[Beggar]] is a Yogscast-used role in [[Trouble in Terrorist Town]].
...
## Role Function
Jester-style opportunist who seeks resources from others and can shift allegiance based on interaction rules.
...
Ability = {
  ...
  "name": "Beggar Ability",
  "requirements": [
    "Actor currently has the 'Beggar' role",
  ...
  "effects": [
    {
      ...
      "event": {
        ...
        "Payload": {
          "role": "Beggar",
          "ability_function": "Jester-style opportunist who seeks resources from others and can shift allegiance based on interaction rules.",
...
- Goal State: Satisfy Beggar's personal jester-style victory trigger before standard team wins resolve.
