[[Boxer]] is a Yogscast-used role in [[Trouble in Terrorist Town]].
...
## Role Function
Close-range disruption role that forces awkward engagements and social misreads through melee-focused play.
...
Ability = {
  ...
  "name": "Boxer Ability",
  "requirements": [
    "Actor currently has the 'Boxer' role",
  ...
  "effects": [
    {
      ...
      "event": {
        ...
        "Payload": {
          "role": "Boxer",
          "ability_function": "Close-range disruption role that forces awkward engagements and social misreads through melee-focused play.",
...
- Goal State: Satisfy Boxer's personal jester-style victory trigger before standard team wins resolve.
