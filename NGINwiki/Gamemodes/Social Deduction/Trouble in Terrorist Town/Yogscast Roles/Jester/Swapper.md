[[Swapper]] is a Yogscast-used role in [[Trouble in Terrorist Town]].
...
## Role Function
Jester role that swaps roles with its killer, often leaving the killer at critical health.
...
Ability = {
  "id": "ability.swapper",
  "name": "Swapper Ability",
  "requirements": [
    "Actor currently has the 'Swapper' role",
  ...
  "effects": [
    {
      ...
      "event": {
        ...
        "Payload": {
          "role": "Swapper",
          "ability_function": "Jester role that swaps roles with its killer, often leaving the killer at critical health.",
...
- Goal State: Satisfy Swapper's personal jester-style victory trigger before standard team wins resolve.
