[[Sponge]] is a Yogscast-used role in [[Trouble in Terrorist Town]].
...
## Role Function
Jester role that redirects nearby damage to itself and seeks death for a win trigger.
...
Ability = {
  ...
  "name": "Sponge Ability",
  "requirements": [
    "Actor currently has the 'Sponge' role",
  ...
  "effects": [
    {
      ...
      "event": {
        ...
        "Payload": {
          "role": "Sponge",
          "ability_function": "Jester role that redirects nearby damage to itself and seeks death for a win trigger.",
...
- Goal State: Satisfy Sponge's personal jester-style victory trigger before standard team wins resolve.
