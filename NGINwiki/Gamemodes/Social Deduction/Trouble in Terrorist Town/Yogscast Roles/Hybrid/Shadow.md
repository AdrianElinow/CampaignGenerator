[[Shadow]] is a Yogscast-used role in [[Trouble in Terrorist Town]].

- Team Classification: [[Yogscast Independent Roles|Independent]], [[Yogscast Jester Roles|Jester]]
- Category Source: Yogscast TTT role taxonomy
- Vault Category: [[Yogscast Hybrid Roles|Hybrid]]

## Role Function
Hybrid chaos role whose threat profile shifts with vision/deception conditions and team state.
...
Ability = {
  ...
  "name": "Shadow Ability",
  "requirements": [
    "Actor currently has the 'Shadow' role",
  ...
  "effects": [
    {
      ...
      "event": {
        ...
        "Payload": {
          "role": "Shadow",
          "ability_function": "Hybrid chaos role whose threat profile shifts with vision/deception conditions and team state.",
...
- Goal State: Resolve Shadow's dual-alignment objective by selecting and executing the winning side-path for the current round state.
