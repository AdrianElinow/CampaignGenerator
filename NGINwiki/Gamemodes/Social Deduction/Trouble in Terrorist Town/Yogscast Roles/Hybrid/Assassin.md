[[Assassin]] is a Yogscast-used role in [[Trouble in Terrorist Town]].

- Team Classification: [[Yogscast Independent Roles|Independent]], [[Yogscast Traitor Roles|Traitor]]
- Category Source: Yogscast TTT role taxonomy
- Vault Category: [[Yogscast Hybrid Roles|Hybrid]]

## Role Function
Deals high damage to a designated target and reduced damage to others, cycling targets as players die.
  ...
  "effects": [
    {
      ...
      "event": {
        ...
        "Payload": {
          "role": "Assassin",
          "ability_function": "Deals high damage to a designated target and reduced damage to others, cycling targets as players die.",
...
- Goal State: Resolve Assassin's dual-alignment objective by selecting and executing the winning side-path for the current round state.
