[[Drunk]] is a Yogscast-used role in [[Trouble in Terrorist Town]].
...
## Role Function
Independent wildcard that sobers into another role/team later, destabilizing early-round reads.
...
Ability = {
  ...
  "name": "Drunk Ability",
  "requirements": [
    "Actor currently has the 'Drunk' role",
  ...
  "effects": [
    {
      ...
      "event": {
        ...
        "Payload": {
          "role": "Drunk",
          "ability_function": "Independent wildcard that sobers into another role/team later, destabilizing early-round reads.",
...
- Goal State: Reach Drunk's independent victory state (survival/elimination/conversion objective) without relying on team victory.
