[[Infected]] is a Yogscast-used role in [[Trouble in Terrorist Town]].
...
## Role Function
Independent conversion killer that spreads infection through close combat.
...
Ability = {
  "id": "ability.infected",
  "name": "Infected Ability",
  "requirements": [
    "Actor currently has the 'Infected' role",
  ...
  "effects": [
    {
      ...
      "event": {
        ...
        "Payload": {
          "role": "Infected",
          "ability_function": "Independent conversion killer that spreads infection through close combat.",
...
- Goal State: Reach Infected's independent victory state (survival/elimination/conversion objective) without relying on team victory.
