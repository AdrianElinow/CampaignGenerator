[[Serial Killer]] is a Yogscast-used role in [[Trouble in Terrorist Town]].
...
## Role Function
Independent elimination role that must outlast and kill all other teams.
...
```json
Ability = {
  "id": "ability.serial_killer",
  "name": "Serial Killer Ability",
  "requirements": [
    "Actor currently has the 'Serial Killer' role",
  ...
  "effects": [
    {
      ...
      "event": {
        ...
        "Payload": {
          "role": "Serial Killer",
          "ability_function": "Independent elimination role that must outlast and kill all other teams.",
...
- Goal State: Reach Serial Killer's independent victory state (survival/elimination/conversion objective) without relying on team victory.
