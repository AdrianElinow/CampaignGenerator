[[Communist]] is a Yogscast-used role in [[Trouble in Terrorist Town]].
...
## Role Function
Independent conversion/control role with team-shifting pressure and anti-consensus win play.
...
```json
Ability = {
  "id": "ability.communist",
  "name": "Communist Ability",
  "requirements": [
    "Actor currently has the 'Communist' role",
  ...
  "effects": [
    {
      ...
      "event": {
        ...
        "Payload": {
          "role": "Communist",
          "ability_function": "Independent conversion/control role with team-shifting pressure and anti-consensus win play.",
...
- Goal State: Reach Communist's independent victory state (survival/elimination/conversion objective) without relying on team victory.
