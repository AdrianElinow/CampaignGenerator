[[Elf]] is a Yogscast-used role in [[Trouble in Terrorist Town]].
...
## Role Function
Independent converter that spreads the Elf state to other players to pursue a conversion-style win.
...
Ability = {
  ...
  "name": "Elf Ability",
  "requirements": [
    "Actor currently has the 'Elf' role",
  ...
  "effects": [
    {
      ...
      "event": {
        ...
        "Payload": {
          "role": "Elf",
          "ability_function": "Independent converter that spreads the Elf state to other players to pursue a conversion-style win.",
...
- Goal State: Reach Elf's independent victory state (survival/elimination/conversion objective) without relying on team victory.
