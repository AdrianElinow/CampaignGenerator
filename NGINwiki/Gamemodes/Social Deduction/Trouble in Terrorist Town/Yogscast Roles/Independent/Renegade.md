[[Renegade]] is a Yogscast-used role in [[Trouble in Terrorist Town]].
...
## Role Function
Independent role with side-switching or self-win incentives that destabilize alliances.
...
Ability = {
  "id": "ability.renegade",
  "name": "Renegade Ability",
  "requirements": [
    "Actor currently has the 'Renegade' role",
  ...
  "effects": [
    {
      ...
      "event": {
        ...
        "Payload": {
          "role": "Renegade",
          "ability_function": "Independent role with side-switching or self-win incentives that destabilize alliances.",
...
- Goal State: Reach Renegade's independent victory state (survival/elimination/conversion objective) without relying on team victory.
