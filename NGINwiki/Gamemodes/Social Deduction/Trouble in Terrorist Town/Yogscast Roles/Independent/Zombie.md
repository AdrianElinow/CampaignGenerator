[[Zombie]] is a Yogscast-used role in [[Trouble in Terrorist Town]].
...
## Role Function
Independent conversion role that spreads by melee infection and overwhelms through numbers.
...
Ability = {
  ...
  "name": "Zombie Ability",
  "requirements": [
    "Actor currently has the 'Zombie' role",
  ...
  "effects": [
    {
      ...
      "event": {
        ...
        "Payload": {
          "role": "Zombie",
          "ability_function": "Independent conversion role that spreads by melee infection and overwhelms through numbers.",
...
- Goal State: Reach Zombie's independent victory state (survival/elimination/conversion objective) without relying on team victory.
