...
```json
Ability = {
  "id": "ability.announcer",
  "name": "Announcer Ability",
  "requirements": [
    "Actor currently has the 'Announcer' role",
  ...
  "effects": [
    {
      ...
      "event": {
        ...
        "Payload": {
          "role": "Announcer",
          "ability_function": "Learns when other players buy items, creating economy-based information for team coordination.",
