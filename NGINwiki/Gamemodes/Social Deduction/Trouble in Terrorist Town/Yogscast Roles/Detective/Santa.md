[[Santa]] is a Yogscast-used role in [[Trouble in Terrorist Town]].
...
## Role Function
Detective support role that distributes gifts/coal to influence loadouts and behavior.
...
Ability = {
  ...
  "name": "Santa Ability",
  "requirements": [
    "Actor currently has the 'Santa' role",
  ...
  "effects": [
    {
      ...
      "event": {
        ...
        "Payload": {
          "role": "Santa",
          "ability_function": "Detective support role that distributes gifts/coal to influence loadouts and behavior.",
