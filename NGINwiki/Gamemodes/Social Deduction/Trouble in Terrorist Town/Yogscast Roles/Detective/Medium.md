[[Medium]] is a Yogscast-used role in [[Trouble in Terrorist Town]].
...
## Role Function
Detective information role with dead-player communication style utility.
...
Ability = {
  ...
  "name": "Medium Ability",
  "requirements": [
    "Actor currently has the 'Medium' role",
  ...
  "effects": [
    {
      ...
      "event": {
        ...
        "Payload": {
          "role": "Medium",
          "ability_function": "Detective information role with dead-player communication style utility.",
