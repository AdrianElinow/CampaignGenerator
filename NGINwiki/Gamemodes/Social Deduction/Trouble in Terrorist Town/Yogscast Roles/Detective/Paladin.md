[[Paladin]] is a Yogscast-used role in [[Trouble in Terrorist Town]].
...
## Role Function
Detective support role that protects nearby allies and boosts team durability.
...
Ability = {
  "id": "ability.paladin",
  "name": "Paladin Ability",
  "requirements": [
    "Actor currently has the 'Paladin' role",
  ...
  "effects": [
    {
      ...
      "event": {
        ...
        "Payload": {
          "role": "Paladin",
          "ability_function": "Detective support role that protects nearby allies and boosts team durability.",
