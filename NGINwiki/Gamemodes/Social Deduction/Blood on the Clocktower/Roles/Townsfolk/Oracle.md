[[Oracle]] is a [[Blood on the Clocktower Role]] in [[Blood on the Clocktower]].
...
Ability = {
  ...
  "name": "Oracle Ability",
  "requirements": [
    "Actor currently has the 'Oracle' role",
  ...
  "effects": [
    {
      ...
      "event": {
        ...
        "Payload": {
          "role": "Oracle",
          "ability_function": "Each night, learn how many dead players are evil.",
