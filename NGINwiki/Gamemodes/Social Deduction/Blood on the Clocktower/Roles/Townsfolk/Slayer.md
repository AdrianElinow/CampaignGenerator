[[Slayer]] is a [[Blood on the Clocktower Role]] in [[Blood on the Clocktower]].
...
Ability = {
  ...
  "name": "Slayer Ability",
  "requirements": [
    "Actor currently has the 'Slayer' role",
  ...
  "effects": [
    {
      ...
      "event": {
        ...
        "Payload": {
          "role": "Slayer",
          "ability_function": "Once per game during the day, choose a player; if they are the Demon, they die.",
