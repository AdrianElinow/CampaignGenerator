[[Fool]] is a [[Blood on the Clocktower Role]] in [[Blood on the Clocktower]].
...
Ability = {
  ...
  "name": "Fool Ability",
  "requirements": [
    "Actor currently has the 'Fool' role",
  ...
  "effects": [
    {
      ...
      "event": {
        ...
        "Payload": {
          "role": "Fool",
          "ability_function": "The first time you would die, you do not.",
