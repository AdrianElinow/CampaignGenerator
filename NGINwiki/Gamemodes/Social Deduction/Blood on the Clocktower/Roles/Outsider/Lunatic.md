[[Lunatic]] is a [[Blood on the Clocktower Role]] in [[Blood on the Clocktower]].
...
Ability = {
  "id": "ability.lunatic",
  "name": "Lunatic Ability",
  "requirements": [
    "Actor currently has the 'Lunatic' role",
  ...
  "effects": [
    {
      ...
      "event": {
        ...
        "Payload": {
          "role": "Lunatic",
          "ability_function": "You think you are the Demon, but you are not.",
